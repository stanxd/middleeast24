      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            <a href="#" className="text-gray-700 hover:text-navy-900 font-medium transition-colors">Home</a>
            ...
            <a href="#" className="text-gray-700 hover:text-navy-900 font-medium transition-colors">About</a>
          </nav>
